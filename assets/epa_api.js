        ...
        .then(function(data){
            ...
            for(let i = 0; i < data.data.length; i++){
                if(data.data[i].designation !== "National Historic Trail"){
                    $(`#result${i}`).append($(`#searchResultsContainer`));
                    $(`<div class = "is-flex is-justify-content: space-between, space-evenly, flex-direction: row-reverse card box result">
                        ...
                        </div>`).insertAfter($(`#searchResultsContainer`));
